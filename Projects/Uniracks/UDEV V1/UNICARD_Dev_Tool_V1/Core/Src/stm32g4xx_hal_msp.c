...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PB12     ------> ADC1_IN11
    */
    HAL_GPIO_DeInit(PWR3V3_ISENSE_ADC1IN10_GPIO_Port, PWR3V3_ISENSE_ADC1IN10_Pin);

    HAL_GPIO_DeInit(VIN_SENSE_ADC1_IN11_GPIO_Port, VIN_SENSE_ADC1_IN11_Pin);
  ...
  /* USER CODE END ADC2_MspDeInit 0 */
    ...
    PA4     ------> ADC2_IN17
    */
    HAL_GPIO_DeInit(PWR5VISENSE_ADC2IN17_GPIO_Port, PWR5VISENSE_ADC2IN17_Pin);
  ...
  /* USER CODE END ADC5_MspDeInit 0 */
    ...
    PA8     ------> ADC5_IN1
    */
    HAL_GPIO_DeInit(VCC_ISENSE_ADC5_IN1_GPIO_Port, VCC_ISENSE_ADC5_IN1_Pin);
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  ...
  /* USER CODE END UART4_MspDeInit 0 */
    ...
    PC11     ------> UART4_RX
    */
    HAL_GPIO_DeInit(GPIOC, ESP32_TX_UART4_Pin|ESP32_RX_UART4_Pin);
  ...
  /* USER CODE END USART1_MspDeInit 0 */
    ...
    PA9     ------> USART1_TX
    */
    HAL_GPIO_DeInit(FLR_USART1RX_GPIO_Port, FLR_USART1RX_Pin);

    HAL_GPIO_DeInit(FLT_USART1TX_GPIO_Port, FLT_USART1TX_Pin);
  ...
  /* USER CODE END USART2_MspDeInit 0 */
    ...
    PA3     ------> USART2_RX
    */
    HAL_GPIO_DeInit(GPIOA, RS485_USART2DE_Pin|RS485_USART2TX_Pin|RS485_USART2RX_Pin);
